...
namespace ECommerce.IntegrationTests.SeedWork
{
    public class TestBase
    {
        ...
        {
            ConnectionString = "Server=(local);Database=ECommerceDemo;Integrated Security=SSPI;MultipleActiveResultSets=true;Encrypt=false";

			await using var sqlConnection = new SqlConnection(ConnectionString);

            await ClearDatabase(sqlConnection);

            EmailsSettings = new EmailsSettings {FromAddressEmail = "fromemail.com"};
