...
using ECommerce.Application.Orders.ChangeCustomerOrder;
using ECommerce.Application.Orders.GetCustomerOrderDetails;
using ECommerce.Application.Orders.GetCustomerOrders;
using ECommerce.Application.Orders.PlaceCustomerOrder;
using ECommerce.Application.Orders.RemoveCustomerOrder;
