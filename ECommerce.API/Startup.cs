...
{  
    public class Startup
    {
        ...
        private const string ECommerceDemoConnectionString = "ECommerceDemoConnectionString";
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return ApplicationStartup.Initialize(
                services, 
                this._configuration[ECommerceDemoConnectionString],
